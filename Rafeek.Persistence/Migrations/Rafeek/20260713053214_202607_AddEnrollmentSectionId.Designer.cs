...
namespace Rafeek.Persistence.Migrations.Rafeek
{
    ...
    [Migration("20260713053214_202607_AddEnrollmentSectionId")]
    partial class _202607_AddEnrollmentSectionId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.AITimetable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AITimetables", "dbo");
                });

            modelBuilder.Entity("Rafeek.Domain.Entities.AITimetableItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AITimetableItems", "dbo");
                });
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.AcademicSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IncludeTransferHours")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("MaxHoursPerSemester")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AcademicSettings", "dbo");
                });
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.Announcement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.ToTable("ApplicationUsers", "auth", t =>
                        {
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.Assignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.AssignmentSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AssignmentSubmission", "dbo");
                });
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.CareerSuggestion", b =>
                {
                    ...
                    b.ToTable("CareerSuggestion", "dbo");
                });
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.Course", b =>
                {
                    ...
                    b.Property<int>("MidtermPercent")
                        .HasColumnType("int");

                    b.Property<int>("ProjectPercent")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WeeklyLabHours")
                        .HasColumnType("int");

                    b.Property<int>("WeeklyLectureHours")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.CourseRegistrationPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("RegistrationOpeningDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("CourseRegistrationPeriods", "dbo");
                });
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.Grade", b =>
                {
                    ...
                    b.Property<float>("AbsoluteScore")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.GradeScale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.LectureGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.Reminder", b =>
                {
                    ...
                    b.ToTable("Reminders", "dbo");
                });

            modelBuilder.Entity("Rafeek.Domain.Entities.RolePermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.SecuritySetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsForcePasswordChangeEnabled")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("SecuritySettings", "dbo");
                });
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.AITimetableItem", b =>
                {
                    b.HasOne("Rafeek.Domain.Entities.AITimetable", "Timetable")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.AcademicCalendar", b =>
                {
                    ...
                    b.HasOne("Rafeek.Domain.Entities.LectureGroup", "LectureGroup")
                        .WithMany("CalendarEvents")
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.AssignmentSubmission", b =>
                {
                    b.HasOne("Rafeek.Domain.Entities.Assignment", "Assignment")
            ...
            modelBuilder.Entity("Rafeek.Domain.Entities.Enrollment", b =>
                {
                    ...
                    b.HasOne("Rafeek.Domain.Entities.CourseSection", "Section")
                        .WithMany("Enrollments")
