...
{
    public class SimulateGPACommandValidator: AbstractValidator<SimulateGPACommand>
    {
        private readonly IUnitOfWork _ctx;
        private readonly IStringLocalizer<Messages> _localizer;

        public SimulateGPACommandValidator(IUnitOfWork ctx, IStringLocalizer<Messages> localizer)
        {
            _ctx = ctx;
        ...
        {
            return await _ctx.StudentRepository.ExistsAsync(sp => sp.Id == studentId, cancellationToken);
        }
    }
}
