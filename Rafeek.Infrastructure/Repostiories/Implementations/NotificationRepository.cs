...
{
    public class NotificationRepository : BaseEntityRepository<Notification, Guid>, INotificationRepository
    {
        public NotificationRepository(IRafeekDbContext context) : base(context)
        {
        }
    }
}
